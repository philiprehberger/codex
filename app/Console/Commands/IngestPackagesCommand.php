...
class IngestPackagesCommand extends Command
{
    ...
    private const CAPABILITY_PATTERNS = [
        ...
        'rest-api' => ['api-client', 'api-kit', 'api-builder', 'api-error', 'api-versioning', 'fetch', 'http-retry', 'http-client', 'http-helper', 'http-status', 'rest', 'jsonrpc', 'graphql-client'],
        ...
        'observability' => ['log', 'audit', 'metric', 'tracing', 'sentry', 'observability', 'correlation', 'healthcheck', 'circuit', 'retry', 'clock', 'change-tracker', 'tracker', 'inspector', 'profiler', 'timer'],
        'background-queue' => ['queue', 'worker', 'job-kit', 'async-batcher', 'async-queue'],
        'scheduled-jobs' => ['cron', 'scheduler', 'schedule-kit'],
        'workflow-engine' => ['workflow', 'state-machine', 'fsm', 'sync-engine'],
        'rule-engine' => ['rule', 'feature-flag', 'flag-kit', 'validator', 'validation'],
        ...
        'event-tracking' => ['analytics', 'event-tracker', 'plausible', 'event-bus', 'signal-kit', 'tracker'],
        ...
        'gdpr-compliance' => ['gdpr', 'pii', 'data-subject', 'erasure'],
        'data-export' => ['export-kit', 'sql-dump', 'backup-kit', 'dump'],
        'real-time-sync' => ['sse', 'websocket', 'realtime', 'pubsub', 'event-emitter', 'observable', 'reactive'],
        'file-upload-pipeline' => ['upload', 'multipart', 'file-kit'],
