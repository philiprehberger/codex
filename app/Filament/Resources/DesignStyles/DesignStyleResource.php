...
namespace App\Filament\Resources\DesignStyles;
...
class DesignStyleResource extends Resource
{
    protected static ?string $model = DesignStyle::class;
    ...
    {
        return [
            'index' => ManageDesignStyles::route('/'),
        ];
    }
}
